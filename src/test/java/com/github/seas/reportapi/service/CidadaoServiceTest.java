...
public class CidadaoServiceTest {
    ...
    public void setup() {
        ...
        Set<CasosEspeciais> mockCasosEspeciais = new HashSet<>();
        mockCasosEspeciais.add(CasosEspeciais.builder().id(1).nomeclatura("CASO ESPECIAL 1").build());
        mockCasosEspeciais.add(CasosEspeciais.builder().id(2).nomeclatura("CASO ESPECIAL 2").build());
    ...
    public void buscarTodosOsCidadoesComSucesso() {
        ...
        Assert.assertEquals(response.getBody(), mockListaDeCidadoes);
