...
public class CidadaoServiceTest {
    ...
    public void buscarTodosOsCidadoesPorBeneficios() {
        ...
        Set<Integer> mockIdBeneficios = mock(Set.class);
        ...
        when(mockBeneficioRepository.findByIdIn(ArgumentMatchers.eq(mockIdBeneficios))).thenReturn(mockBeneficios);

        ResponseEntity<Page<Cidadao>> response = cidadaoService.listAllCidadoes(mockDto, mockPageable);
